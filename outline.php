      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav mr-auto">
            <li class="nav-item">
              <a class="nav-link" href="" target="_blank">アプリ名とは</a>
            </li>
            <li class="nav-item">
        ...
        <div class="container">
          ...
          <div class="row wow fadeIn pt-5 white-text">
            ...
            <div class="col-md-12  mb-5 pt-5 text-center text-md-left">
              ...
              <p class="pt-5"></p>
              <h1 class="apptitle font-weight-bold text-center white-text">LIP（仮）とは</h1>
            ...
            -->
              ...
              <p class="mt-5 pt-2 text-center appexplain white-text">
                <strong>長期インターンシップをを通して、夢を持つ学生に力を与えるプログラムです。
					<br>参加企業は日本を代表するような素晴らしい企業のみです。
				</strong>
              </p>
